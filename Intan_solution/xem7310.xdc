...
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets external_SCLK_A_IBUF]

# using
# set_property -dict {PACKAGE_PIN M3 IOSTANDARD LVCMOS33} [get_ports external_CS_b_A]
set_property PACKAGE_PIN M3 [get_ports      external_CS_b_A]
set_property IOSTANDARD LVCMOS33 [get_ports external_CS_b_A]
set_property PULLDOWN true [get_ports       external_CS_b_A]

# set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS33} [get_ports external_SCLK_A]
# set_property PACKAGE_PIN M2 [get_ports      external_SCLK_A] original assignment
set_property PACKAGE_PIN L3 [get_ports      external_SCLK_A]
set_property IOSTANDARD LVCMOS33 [get_ports external_SCLK_A]
set_property PULLDOWN true [get_ports       external_SCLK_A]


# set_property -dict {PACKAGE_PIN K6 IOSTANDARD LVCMOS33} [get_ports external_MOSI1_A]
set_property PACKAGE_PIN K6 [get_ports      external_MOSI1_A]
set_property IOSTANDARD LVCMOS33 [get_ports external_MOSI1_A]
set_property PULLDOWN true [get_ports       external_MOSI1_A]


# set_property -dict {PACKAGE_PIN J6 IOSTANDARD LVCMOS33} [get_ports external_MOSI2_A]
set_property PACKAGE_PIN J6 [get_ports      external_MOSI2_A]
set_property IOSTANDARD LVCMOS33 [get_ports external_MOSI2_A]
set_property PULLDOWN true [get_ports       external_MOSI2_A]


# set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports external_MISO1_A] original 
set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS33} [get_ports external_MISO1_A] 
# set_property PACKAGE_PIN L3 [get_ports      external_MISO1_A]
# set_property IOSTANDARD LVCMOS33 [get_ports external_MISO1_A]
# set_property PULLDOWN true [get_ports       external_MISO1_A]

set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports external_MISO2_A]
# set_property PACKAGE_PIN K3 [get_ports      external_MISO2_A]
# set_property IOSTANDARD LVCMOS33 [get_ports external_MISO2_A]
# set_property PULLDOWN true [get_ports       external_MISO2_A]
...
# Originally used these lines, but commentted out
